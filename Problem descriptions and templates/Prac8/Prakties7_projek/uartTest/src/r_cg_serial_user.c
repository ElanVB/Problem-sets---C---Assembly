...
extern uint8_t  uart0RxFlag;    // UART0 Receive flag
extern uint8_t  uart0TxFlag;    // UART0 Transmit end flag
extern uint8_t	uart0RxErrFlag;	// UART0 Receive Error Flag
extern uint8_t  uart0RxOvrFlag;	// UART0 Receive Overrun Flag
...
extern uint8_t  uart2RxFlag;    // UART2 Receive Flag
extern uint8_t  uart2TxFlag;    // UART2 Transmit end flag
extern uint8_t	uart2RxErrFlag;	// UART2 Receive Error Flag
extern uint8_t  uart2RxOvrFlag;	// UART2 Receive Overrun Flag
/* End user code. Do not edit comment generated here */
