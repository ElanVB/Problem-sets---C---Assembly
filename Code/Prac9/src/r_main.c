...
//I didnt like that the counter or resister values were in ASCCI chars so I wrote this function to convert the chars to integers that were then sent to the uart2 to be transmitted instead
int convertToNum(uint8_t* buf)
{
